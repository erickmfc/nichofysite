          ...
          <div className="max-w-sm mx-auto">
            ...
            <div className="mb-6">
              <Button
                ...
                className="w-full bg-white border-2 border-gray-200 text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 py-4 text-base font-medium rounded-xl"
              >
